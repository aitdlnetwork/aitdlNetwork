      ...
      <section className="flex flex-col items-center justify-center min-h-[90vh] px-6">
        <div className="max-w-[1200px] w-full mx-auto flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto animate-slide-up mb-16">
            <Link to="/contact" className="btn-primary w-full sm:w-auto flex items-center justify-center h-12 px-8 rounded-lg bg-primary text-background-dark font-display font-semibold text-[15px] tracking-[0.01em]">
                Get Free Demo
            </Link>
            <Link to="/services" className="btn-secondary w-full sm:w-auto flex items-center justify-center h-12 px-8 rounded-lg bg-transparent font-display font-semibold text-[15px] tracking-[0.01em]">
                View Solutions
            </Link>
          </div>
          {/* Trust Badges */}
      ...
      <section className="relative z-10 py-24 px-6 bg-background-dark/50" id="services">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="mt-16 text-center">
            <Link to="/contact" className="btn-primary inline-flex items-center justify-center h-14 px-10 rounded-lg bg-primary text-background-dark font-display font-semibold text-[16px]">
              Get Free Demo
            </Link>
          </div>
        </div>
