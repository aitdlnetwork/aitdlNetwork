        ...
        <div className="w-[400px] border-r border-white/5 bg-[#12122a]/50 p-6 overflow-y-auto print:hidden space-y-6 form-sidebar">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select value={form.vendorId} onChange={handleVendorChange} className="w-full bg-black/30 border border-white/10 rounded px-3 py-1.5 text-sm text-white outline-none focus:border-primary mb-2">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea rows={2} value={form.notes} onChange={e=>setForm({...form, notes: e.target.value})} className="w-full bg-black/30 border border-white/10 rounded px-3 py-1.5 text-sm text-white outline-none focus:border-primary"/>
            </div>
          </div>
        </div>
           ...
           <div className="w-[794px] min-h-[1123px] bg-white text-black p-12 shadow-[0_0_50px_rgba(0,0,0,0.5)] print:shadow-none print:p-0 relative font-['DM_Sans',sans-serif]">
              ...
              {form.notes && (
                <div className="mb-6">
                  ...
                  <div className="whitespace-pre-line text-sm text-slate-700 bg-slate-50 p-4 border border-slate-100 rounded-lg">{form.notes}</div>
                </div>
              )}
