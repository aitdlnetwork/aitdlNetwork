...
export const translations: Record<string, TranslationDict> = {
  ...
  hi: {
    ...
    db_secure_session: "सत्र सक्रिय",
    db_decommission: "लॉग आउट करें",
    db_overview_subtitle: "वास्तविक समय प्रणाली स्वास्थ्य और कनेक्टिविटी निदान।",
    db_crm_subtitle: "क्लाइंट रिकॉर्ड और प्रशासनिक कार्यों का प्रबंधन करें।",
  ...
  sa: {
    ...
    db_secure_session: "सत्रम् सक्रियम्",
    db_decommission: "लॉग आउट",
    db_overview_subtitle: "तन्त्र व्यवस्थापनम्।",
    db_crm_subtitle: "प्रशासन कार्यक्षेत्रम्।",
