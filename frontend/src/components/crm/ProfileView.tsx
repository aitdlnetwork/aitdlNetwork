  ...
  return (
    <div className="glass-card p-6 rounded-xl border border-white/5 bg-background-dark/30 flex flex-col gap-6 animate-fade-in">
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-slate-500 font-semibold text-[11px] uppercase tracking-widest">{t.profile_title}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
          <div className="border border-white/5 p-4 rounded-xl bg-white/5 flex flex-col gap-1 hover:bg-white/10 transition-all cursor-pointer">
            <span className="text-slate-500 text-xs font-semibold uppercase tracking-widest">{t.profile_role}</span>
            <span className="text-white font-medium text-sm tracking-wide">{user.role.toUpperCase()}</span>
          </div>
          <div className="border border-white/5 p-4 rounded-xl bg-white/5 flex flex-col gap-1 hover:bg-white/10 transition-all cursor-pointer">
            <span className="text-slate-500 text-xs font-semibold uppercase tracking-widest">{t.profile_since}</span>
            <span className="text-white font-medium text-sm tracking-wide">March 2026</span>
          </div>
        </div>
